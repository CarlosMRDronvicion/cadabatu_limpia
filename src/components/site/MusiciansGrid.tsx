...
const musicians: Musician[] = [
  ...
  },
  {
    ...
    role: "Percusionista",
    instrument: "Caja",
    bio: "Carla, actual estudiante y futura matrona, comenzó su trayectoria musical hace unos años dentro del mundo de las batucadas, donde descubrió una gran pasión por la percusión. Actualmente está empezando a participar en bandas, charangas y grupos tradicionales con el objetivo de seguir aprendiendo, ampliar su experiencia y crecer profesionalmente dentro de la música. Su energía, constancia y carácter activo hacen que siempre esté dispuesta a involucrarse en nuevos proyectos. A veces puede resultar un poco insoportable, pero su lado adorable y su forma de ser hacen que sea imposible no cogerle cariño. Su entusiasmo y ganas de superarse la convierten en una pieza muy especial dentro del grupo.",
    img: cf,
  },
  {
    name: "Fran Fernández",
    role: "Percusionista",
    instrument: "Surdo 1ª",
    bio: "Fran, conocido cariñosamente como el papá de la batucada, trabaja actualmente en el sector del cristal, aunque no hay tarea que se le resista, ya que sabe hacer prácticamente de todo y siempre está dispuesto a echar una mano a quien lo necesite. Aunque su trayectoria musical es todavía escasa, ha encontrado en la batucada un espacio perfecto para aprender, crecer y desarrollar todo su potencial. Su energía, amabilidad y constante disposición para ayudar hacen que sea una persona fundamental dentro del grupo. Con su experiencia de vida y su actitud positiva, no solo tiene mucho que crecer musicalmente, sino que también puede ayudarnos a crecer a todos a nivel personal.",
    img: ff,
  },
  {
  ...
  },
   {
    ...
    role: "Percusionista",
    instrument: "Surdo 3ª",
    bio: "La familia crece… ¿quieres conocerles?",
    img: pm,
  },
  {
    name: "S.",
